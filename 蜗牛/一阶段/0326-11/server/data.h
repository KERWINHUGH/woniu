...
typedef enum {
	...
	DESC_SALSRY,				//**按工资降序显示员工信息**：显示所有员工信息，按工资从大到小排序。
	ASC_AGE,					//**按年龄升序显示员工信息**：显示所有员工信息，按年龄从小到大排序。
	GENDER_BY_DEPARTEMNT,		//**显示指定部门的男女员工人数**：
	AVG_SALARY_BY_DEPARTMENT, 	//**统计每个部门的平均工资并显示**：
	COUNT_BY_TITLE,				//**统计管理层和基层员工人数并显示**
