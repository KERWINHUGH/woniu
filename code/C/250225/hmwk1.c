...
void hmwk2()
{
	 ...
	 int arr[oneLength][twoLength];
	  //oneLength=sizeof(arr)/sizeof(arr[0]);
	  //twoLength=sizeof(arr[0])/sizeof(arr[0][0]);
	 
	 int aver[oneLength];//存放每个一维数组的平均数
	 int tempSum =0;//存放每个一维数组的总和
