...
char *op_to_string(OP op){
	switch(op){
		...
		case DESC_SALARY:	return "DESC_SALARY";
		case ASC_AGE:	return "ASC_AGE";
		case GENDER_BY_DEPARTEMNT:	return "GENDER_BY_DEPARTEMNT";
		case AVG_SALARY_BY_DEPARTMENT:	return "AVG_SALARY_BY_DEPARTMENT";
		case COUNT_BY_TITLE:	return "COUNT_BY_TITLE";
...
OP string_to_op(const char *str){
	...
	if(strcmp(str,"DESC_SALARY") == 0 )
	return DESC_SALARY;
	if(strcmp(str,"ASC_AGE") == 0 )
	return ASC_AGE;
	if(strcmp(str,"GENDER_BY_DEPARTEMNT") == 0 )
	return GENDER_BY_DEPARTEMNT;
	if(strcmp(str,"AVG_SALARY_BY_DEPARTMENT") == 0 )
	return AVG_SALARY_BY_DEPARTMENT;
	if(strcmp(str,"COUNT_BY_TITLE") == 0 )
